...
package com.farsunset.cpush.nio.constant;
...
public   interface  CIMConstant  {
	...
	/**
	 * 对应ichat 中 spring-cpush.xml  > bean:mainIoHandler >handlers
	 * 为 服务端处理对应的handlers，应该继承与com.farsunset.cpush.nio.handle.AbstractHandler
	 * @author xiajun
	 *
	 */
